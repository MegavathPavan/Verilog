...
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { A[0] }]; #rpio_24
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { A[1] }]; #rpio_25

##Switches##
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { loadC }]; #rpio_14
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { loadB }]; #rpio_15
#set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { loadC }]; #rpio_16
