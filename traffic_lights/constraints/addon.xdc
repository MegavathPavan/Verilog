...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { C[6] }]; #rpio_sd
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { C[5] }]; #rpio_sc 
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { C[4] }]; #rpio_02
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { C[3] }]; #rpio_03
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { C[2] }]; #rpio_04
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { C[1] }]; #rpio_05
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { C[0] }]; #rpio_06
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { SSD_CP }]; #rpio_07

set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { En[0] }]; #rpio_08
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports {  En[1]}]; #rpio_09
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { En[2] }]; #rpio_10
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { En[3] }]; #rpio_11
